...
namespace DesdinovaModelPipeline.Helpers
{
    public class MathHelper2
    {
        ...
        public static Vector3 PointOnBezierCurve3(Vector3 p1, Vector3 p2, Vector3 p3, float t)
        {
           float mum1,mum12,mu2 = 0.0f;
        ...
        public static Vector3 PointOnBezierCurve4(Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4, float t)
        {
	        float var1, var2, var3 = 0.0f;
            Vector3 vPoint = Vector3.Zero;
        ...
        public static Vector3 PointOnBezierCurveN(Vector3[] p, int n, double t)
        {
           int k,kn,nn,nkn = 0;
           double blend,muk,munk = 0;
           Vector3 vPoint = Vector3.Zero;
           ...
           for (k=0;k<=n;k++) 
           {
              ...
              vPoint.X += p[k].X * (float)blend;
              vPoint.Y += p[k].Y * (float)blend;
              vPoint.Z += p[k].Z * (float)blend;
           }
        ...
        public static Vector3 Corner(BoundingBox b, int n)
        {
            ...
            p.Y = ((n & 2) == 1) ? b.Max.Y : b.Min.Y;
            p.Z = ((n & 4) == 1) ? b.Max.Z : b.Min.Z;
            return p;
        }
    }
}
